...
function init() {
    ...
    if (document.querySelector("#contact-page-area")) {
        ...
        new (0, _contactDefault.default)("email", "tjryan13579@gmail.com");
    }
        ...
        collapsibleItems.forEach((item)=>{
            ...
            toggleButton.addEventListener("click", ()=>{
                if (content.classList.contains("open")) {
                    ...
                    if (arrow) arrow.classList.remove("list-arrow-rotate");
                    if (expandSymbol) expandSymbol.classList.remove("expanded-icon");
                    if (expandText) expandText.textContent = "See more";
                    content.style.maxHeight = null;
                } else {
                    content.classList.add("open");
                    if (arrow && !expandSymbol) arrow.classList.add("list-arrow-rotate");
                    if (expandSymbol) expandSymbol.classList.add("expanded-icon");
                    if (expandText) expandText.textContent = "See less";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3C9CX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class CopyOnClick {
